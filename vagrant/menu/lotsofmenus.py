"""Add many restaurants and menu items to the database."""
...
menuItem2 = MenuItem(name="Peking Duck",
                     description=("A famous duck dish from Beijing[1] that has "
                                  "been prepared since the imperial era. The "
                                  "meat is prized for its thin, crisp skin, "
...
menuItem5 = MenuItem(name="Beef Noodle Soup",
                     description=("A Chinese noodle soup made of stewed or red "
                                  "braised beef, beef broth, vegetables and "
                                  "Chinese noodles."),
                     price="14",
                     course="Entree",
                     restaurant=restaurant2)
...
menuItem6 = MenuItem(name="Ramen",
                     description=("A Japanese noodle soup dish. It consists of "
                                  "Chinese-style wheat noodles served in a "
...
menuItem3 = MenuItem(name="Gyoza",
                     description=("The most prominent differences between "
                                  ...
                                  "light seasoning of Japanese gyoza with salt "
                                  "and soy sauce, and the fact that gyoza "
                                  "wrappers are much thinner"),
                     price="$9.95",
                     course="Entree",
                     restaurant=restaurant1)
...
menuItem3 = MenuItem(name="Honey Boba Shaved Snow",
                     description=("Milk snow layered with honey boba, jasmine "
                                  "tea jelly, grass jelly, caramel, cream, and "
                                  "freshly made mochi"),
                     price="$4.50",
                     course="Dessert",
                     restaurant=restaurant1)
...
menuItem4 = MenuItem(name="Cauliflower Manchurian",
                     description=("Golden fried cauliflower florets in a midly "
                                  "spiced soya,garlic sauce cooked with fresh "
                                  "cilantro, celery, chilies,ginger & green "
                                  "onions"),
                     price="$6.95",
                     course="Appetizer",
                     restaurant=restaurant1)
...
menuItem4 = MenuItem(name=("Choc Full O\' Mint (Smitten\'s Fresh Mint Chip ice "
                           "cream)"),
...
menuItem1 = MenuItem(name="Lamb Curry",
                     description=("Slow cook that thang in a pool of tomatoes, "
                                  "onions and alllll those tasty Indian "
                                  "spices. Mmmm."),
                     price="$9.95",
                     course="Entree",
                     restaurant=restaurant1)
...
menuItem1 = MenuItem(name="Boysenberry Sorbet",
                     description=("An unsettlingly huge amount of ripe berries "
                                  "turned into frozen (and seedless) "
                                  "awesomeness"),
                     price="$2.99",
                     course="Dessert",
                     restaurant=restaurant1)
...
menuItem1 = MenuItem(name="Lemon Curd Ice Cream Sandwich",
                     description=("Lemon Curd Ice Cream Sandwich on a "
                                  "chocolate macaron with cardamom meringue "
                                  "and cashews"),
                     price="$4.25",
                     course="Dessert",
                     restaurant=restaurant1)
